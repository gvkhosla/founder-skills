...
- Rewrite `founder-partner`, `problem-validator`, `customer-hypothesis`, and `mvp-scoper` as more explicit phased workflows.
...
- Fix Codex global install so `$founder-partner` style invocation works from `~/.codex/skills`.
