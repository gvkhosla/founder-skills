...
Goal: Finds the most likely reason users are leaving. Use when churn rises, retention is confusing, or feedback is noisy. Returns the root-cause call in churn-diagnosis.md.
